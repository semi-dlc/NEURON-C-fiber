...
NEURON {
	...
	RANGE ICaPmax, KmCa, ica, icap, celsiusT		:Allows variables to be modified in hoc and collected in vectors
}
...
INITIAL {
	ICaPmax = ICaPmax22*Q10CaP^((Q10TempA-celsiusT)/Q10TempB)
}
